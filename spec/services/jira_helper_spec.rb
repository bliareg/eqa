...
RSpec.describe JiraHelper do
  before :all do
    project = create(:setup_project)
    @setting = create(:jira_setting, project: project)
    @helper = @setting.helper
  end

  context 'initialize' do
    it 'project_key' do
      @helper.project_key.should == @setting.project_key
    end

    it 'board_name' do
      @helper.board_name.should == @setting.board_name
    end
  end
